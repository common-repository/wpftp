...
define( 'WPFTP_VERSION', 4.1 );  // 插件数据版本
...
function my_enqueue() {
	...
	wp_enqueue_style( 'mytheme-options-style', plugin_dir_url( __FILE__ )  . 'layui/css/layui.css' ); 
	wp_enqueue_style( 'mytheme-laobuluo-style', plugin_dir_url( __FILE__ )  . 'layui/css/laobuluo.css' ); 
    wp_enqueue_script( 'my_custom_script', plugin_dir_url( __FILE__ ) . 'layui/layui.js' );
